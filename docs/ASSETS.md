...
| `audio/cc0/kenney/scifi/` | Sci-fi Sounds (70 files) | Kenney | CC0 | https://kenney.nl/assets/sci-fi-sounds | Boost drink start/end, health pickup; placeholders for the factory machine's alarm, steam hiss, arm movement and clunk, and the ACTIVATE button |
...
- Factory machine audio: an alarm, a steam hiss loop, a hydraulic arm move and a heavy metal clunk. Kenney sci-fi clips stand in; the meltdown still borrows `kick_prop`.
